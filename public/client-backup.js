...
var username = 'mvFz48F81N0E4eNEvkO4M510NQqb3HC-9n6ewLZO';
var usernameField;
var addressField;
...
function setup() {
  ...
  p[0] = new particle(width / 2, height / 2, 1, 0, 0, 60, 0);
  background(80);
  for (let i = 1; i < 20; i++) {
    p[i] = new particle(random(400), random(400), random(0.3,1), random(360), random(70,100), random(80, 100), 0.8)
  }
}
